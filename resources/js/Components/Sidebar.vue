            ...
            <div class="collapse navbar-collapse" id="sidebar-menu">
                <ul class="navbar-nav pt-lg-3">
                    ...
                    <li class="nav-item" :class="{ 'active': $page.url.startsWith('/admin/lessons') }">
                        <Link href="/admin/lessons" class="nav-link">
                        <span
                            class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24"
                                stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round"
                    ...
                    <br>
                    <li class="nav-item dropdown" :class="{ 'active': $page.url.startsWith('/admin/classrooms') }">
                        ...
                        <div class="dropdown-menu" :class="{ 'show': $page.url.startsWith('/admin/classrooms') }">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    <a class="dropdown-item" :class="{ 'active': $page.url.startsWith('/admin/classrooms') }"
